...
/* if(puntaje > 3){
  let scoreTag = '<span> Felicidades! Puntaje <p>'+ puntaje +'</p> de <p>'+baseDePreguntas.length +'</p></span>';
      scoreText.innerHTML = scoreTag; 
}
else if(puntaje > 1){
  let scoreTag = '<span> Eres malo! 👌 Puntaje <p>'+ puntaje +'</p> de <p>'+baseDePreguntas.length +'</p></span>';
      scoreText.innerHTML = scoreTag; 
}
else{
  let scoreTag = '<span> Eres malo! <p>'+ puntaje +'</p> de <p>'+baseDePreguntas.length +'</p></span>';
      scoreText.innerHTML = scoreTag; 
} */